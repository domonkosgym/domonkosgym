      ...
      <div className="relative flex flex-col lg:flex-row min-h-screen">
        ...
        <div className="w-full lg:w-1/2 relative flex flex-col justify-between py-20 px-6 md:px-12 min-h-[60vh] lg:min-h-screen">
          ...
          <div className="ml-6 md:ml-8 lg:ml-16 xl:ml-20 space-y-8 md:space-y-12 max-w-2xl">
            {/* Main Heading */}
            <div>
              <p className="text-primary font-bold text-sm sm:text-base md:text-lg uppercase tracking-wider mb-1">
                {subtitle}
              </p>
              <h1 className="text-[clamp(1.75rem,6vw,4.5rem)] font-black text-foreground uppercase leading-none mb-4 md:mb-6">
