...
export const Header = ({ onCtaClick, ctaText }: HeaderProps) => {
  ...
  return (
    <nav className="absolute top-0 left-0 right-0 z-20 flex justify-between items-center px-2 sm:px-4 md:px-12 py-3 md:py-6 gap-2 bg-background/80 backdrop-blur-sm">
